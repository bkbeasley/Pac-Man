...
export default class Blinky extends Ghost {
    constructor(scene, maze, positionX, positionY) {
        ...
        this.sprite = scene.physics.add
                                    .sprite(positionX, positionY, "blinky", "blinky_01.png")
